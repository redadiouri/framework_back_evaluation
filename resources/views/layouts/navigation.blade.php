<nav x-data="{ open: false }" class="bg-gradient-to-r from-indigo-600 to-indigo-800 border-b border-indigo-900 shadow-lg">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <div class="px-4 py-3 text-sm border-b border-gray-200">
                            <div class="font-semibold text-gray-900">{{ Auth::user()->prenom }} {{ Auth::user()->nom }}</div>
        ...
        <div class="pt-4 pb-1 border-t border-indigo-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('logout')" class="text-red-300 hover:bg-red-600"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Déconnexion') }}
                    </x-responsive-nav-link>
